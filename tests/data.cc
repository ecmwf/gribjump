...
void add_simple_no_bitmask() {
    ...
    testData.push_back(InputData{
        ...
        .expectedString = "JumpInfo[version=4,editionNumber=1,binaryScaleFactor=-10,decimalScaleFactor=0,bitsPerValue="
                          "16,ccsdsFlags=0,ccsdsBlockSize=0,ccsdsRsi=0,referenceValue=227.887,offsetBeforeData=103,"
                          "offsetAfterData=1472,numberOfDataPoints=684,numberOfValues=684,offsetBeforeBitmap=0,"
                          "sphericalHarmonics=0,binaryMultiplier=0.000976562,decimalMultiplier=1,totalLength=1476,"
                          "msgStartOffset=0,md5GridSection=33c7d6025995e1b4913811e77d38ec50,packingType=grid_simple]",
    });
...
void add_surface_level_data() {
    ...
    testData.push_back(InputData{
        ...
        .expectedData   = ecValues,
        .expectedString = "JumpInfo[version=4,editionNumber=1,binaryScaleFactor=-10,decimalScaleFactor=0,bitsPerValue="
                          "16,ccsdsFlags=0,ccsdsBlockSize=0,ccsdsRsi=0,referenceValue=2.32006,offsetBeforeData=195,"
                          "offsetAfterData=1074,numberOfDataPoints=684,numberOfValues=439,offsetBeforeBitmap=98,"
                          "sphericalHarmonics=0,binaryMultiplier=0.000976562,decimalMultiplier=1,totalLength=1078,"
                          "msgStartOffset=0,md5GridSection=33c7d6025995e1b4913811e77d38ec50,packingType=grid_simple]",
    });
    simplePackedData.push_back(testData.back());
}
...
void add_synthetic_data_with_bitmap() {
    ...
    testData.push_back(InputData{
        ...
        .expectedData   = ecValues,
        .expectedString = "JumpInfo[version=4,editionNumber=1,binaryScaleFactor=-1,decimalScaleFactor=0,bitsPerValue="
                          "11,ccsdsFlags=0,ccsdsBlockSize=0,ccsdsRsi=0,referenceValue=0,offsetBeforeData=195,"
                          "offsetAfterData=656,numberOfDataPoints=684,numberOfValues=334,offsetBeforeBitmap=98,"
                          "sphericalHarmonics=0,binaryMultiplier=0.5,decimalMultiplier=1,totalLength=660,"
                          "msgStartOffset=0,md5GridSection=33c7d6025995e1b4913811e77d38ec50,packingType=grid_simple]",
    });
    simplePackedData.push_back(testData.back());
    ...
    testData.push_back(InputData{
        ...
        .expectedData   = ecValues,
        .expectedString = "JumpInfo[version=4,editionNumber=1,binaryScaleFactor=-2,decimalScaleFactor=0,bitsPerValue="
                          "12,ccsdsFlags=0,ccsdsBlockSize=0,ccsdsRsi=0,referenceValue=0,offsetBeforeData=195,"
                          "offsetAfterData=696,numberOfDataPoints=684,numberOfValues=334,offsetBeforeBitmap=98,"
                          "sphericalHarmonics=0,binaryMultiplier=0.25,decimalMultiplier=1,totalLength=700,"
                          "msgStartOffset=0,md5GridSection=33c7d6025995e1b4913811e77d38ec50,packingType=grid_simple]",
    });
    simplePackedData.push_back(testData.back());
    ...
    testData.push_back(InputData{
        ...
        .expectedString = "JumpInfo[version=4,editionNumber=1,binaryScaleFactor=-10,decimalScaleFactor=0,bitsPerValue="
                          "0,ccsdsFlags=0,ccsdsBlockSize=0,ccsdsRsi=0,referenceValue=1.23457,offsetBeforeData=111,"
                          "offsetAfterData=112,numberOfDataPoints=684,numberOfValues=1,offsetBeforeBitmap=98,"
                          "sphericalHarmonics=0,binaryMultiplier=0.000976562,decimalMultiplier=1,totalLength=116,"
                          "msgStartOffset=0,md5GridSection=33c7d6025995e1b4913811e77d38ec50,packingType=grid_simple]",
    });
    simplePackedData.push_back(testData.back());
}
