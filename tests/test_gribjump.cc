...
void doTest(int i, JumpInfo gribInfo, JumpHandle& dataSource) {
    ...
    rangesVector.push_back(std::vector<Interval>{Range(0, 3), Range(30, 60), Range(60, 90), Range(90, 120)});
    ...
    rangesVector.push_back(std::vector<Interval>{Range(200, 220), Range(220, 240), Range(240, 260), Range(600, 684)});
    // ranges with entire words between them
    rangesVector.push_back(std::vector<Interval>{Range(5, 10), Range(130, 135), Range(400, 410)});
