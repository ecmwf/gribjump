...
mod tests {
    ...
    fn test_eckit_exception_caught_by_trycatch() {
        let result = ffi::ExceptionTest::throw_eckit_exception();
    ...
    fn test_eckit_serious_bug_caught_by_trycatch() {
        let result = ffi::ExceptionTest::throw_eckit_serious_bug();
        assert!(result.is_err());
        let err = result.expect_err("expected error");
    ...
    fn test_eckit_user_error_caught_by_trycatch() {
        let result = ffi::ExceptionTest::throw_eckit_user_error();
        assert!(result.is_err());
        let err = result.expect_err("expected error");
    ...
    fn test_std_exception_caught_by_trycatch() {
        let result = ffi::ExceptionTest::throw_std_exception();
        assert!(result.is_err());
        let err = result.expect_err("expected error");
    ...
    fn test_non_std_exception_caught_by_trycatch() {
        let result = ffi::ExceptionTest::throw_int();
        assert!(result.is_err());
        let err = result.expect_err("expected error");
